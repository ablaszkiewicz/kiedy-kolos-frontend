import { Flex, Spacer, HStack, Badge, Text, SlideFade, Slide } from '@chakra-ui/react';
import dayjs from 'dayjs';
import React from 'react';
export function DayCard({ day, monthOffset, direction }: any) {
  ...
  return (
    <SlideFade in={true} offsetX={100 * direction} offsetY={0}>
      <Flex
        direction={'column'}
        align={'center'}
        borderRadius={10}
